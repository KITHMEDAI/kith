...
// by checking for a format-unique key (see lib/note-fields.ts detectNoteFormat).
...
export type NoteFormat = 'soap' | 'emdr' | 'dap' | 'birp';
...
export interface SessionNotes {
  soap_note: SOAPNote | EMDRNote | DAPNote | BIRPNote;
  key_points: string[];
